...
import { 
  Search, CheckCircle, XCircle, Clock, MapPin, Car, 
  Calendar, Loader2, AlertCircle, ArrowRight, CreditCard
} from 'lucide-react';
    ...
    const loadBooking = async () => {
      try {
        ...
        if (response?.data) {
          ...
          if (['accepted', 'confirmed', 'completed'].includes(bookingData.status)) {
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className={`rounded-2xl p-8 mb-6 text-center ${
        ...
        <p className="text-white/80 mb-4">
          {isSearching && 'We\'re finding the best available provider in your area'}
          {isExpired && 'Unfortunately, no providers accepted your request in time'}
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-6 mb-6">
        ...
        <div className="space-y-4">
            ...
            <div>
              ...
              <p className="font-medium text-slate-900 dark:text-white">
                {typeof booking.vehicle === 'string' 
                  ? booking.vehicle 
                  : booking.vehicle 
                    ? `${booking.vehicle.year || ''} ${booking.vehicle.make || ''} ${booking.vehicle.model || ''}`.trim() || 'Not specified'
                    : 'Not specified'
                }
              </p>
            </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-slate-500 dark:text-slate-400">Preferred Date</p>
              <p className="font-medium text-slate-900 dark:text-white">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="font-medium text-slate-900 dark:text-white">
                {booking?.address?.line1 || booking?.serviceAddress?.addressLine1 || 'Address provided'}
              </p>
              <p className="text-sm text-slate-500 dark:text-slate-400">
        ...
        <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-800">
          ...
          <p className="text-xs text-slate-500 mt-1">
            Final price confirmed when provider accepts
          </p>
        </div>
      </div>
      ...
      >
        <div className="space-y-4">
          <p className="text-slate-600 dark:text-slate-400">
            Are you sure you want to cancel this request? Since no provider has accepted yet, 
