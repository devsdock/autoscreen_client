...
import { 
  CheckCircle, Star, MapPin, Calendar, Car, FileText, 
  Download, ArrowRight, Phone, MessageSquare, Clock, Shield
} from 'lucide-react';
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-6 mb-6">
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">
                You'll receive an email with all booking details and provider contact info.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="font-medium text-slate-900 dark:text-white">Provider Contact</p>
              <p className="text-sm text-slate-500 dark:text-slate-400">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="font-medium text-slate-900 dark:text-white">Service Day</p>
              <p className="text-sm text-slate-500 dark:text-slate-400">
                On the scheduled date, the provider will arrive at your location to complete the service.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-6 mb-6">
        ...
        <div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-800">
          ...
          <div className="flex items-center justify-between">
            <span className="font-medium text-slate-900 dark:text-white">Total Paid</span>
