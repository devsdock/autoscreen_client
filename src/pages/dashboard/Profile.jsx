...
const Profile = () => {
  ...
  const handleSaveVehicle = () => {
    if (vehicleModal.vehicle) {
      updateVehicle(vehicleModal.vehicle.id, vehicleForm);
    } else {
  ...
  const toggleNotification = (key) => {
    ...
    updateUser({ notificationPreferences: newNotifications });
  };
  ...
  return (
    <div className="space-y-6">
              ...
              {isEditing ? (
                      ...
                      {['whatsapp', 'phone', 'email'].map((method) => (
                        <label key={method} className="flex items-center gap-2 cursor-pointer">
                          <input
                            ...
                            onChange={() => setEditForm(prev => ({ ...prev, preferredContact: method }))}
                ...
                <div className="flex-1 space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-slate-500">Member since {formatDate(user.memberSince)}</p>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3 text-sm">
                      ...
                      <span className="text-slate-700 capitalize">Preferred: {user.preferredContact}</span>
                    </div>
                    <div className="flex items-center gap-3 text-sm">
                      <Calendar size={16} className="text-slate-400" />
                      <span className="text-slate-700">{totalBookings} total bookings</span>
                    </div>
                  </div>
                </div>
              )}
          ...
          <Card>
            <CardHeader className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">Save your vehicles for faster quoting</p>
              </div>
            ...
            <CardContent>
              {vehicles.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-slate-500 text-sm">No vehicles saved yet</p>
                </div>
              ) : (
                <div className="space-y-3">
          ...
          <Card>
            <CardHeader className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">Save addresses for quicker booking</p>
              </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {[
                { key: 'email', label: 'Email notifications', description: 'Quotes, bookings, receipts' },
                { key: 'sms', label: 'SMS notifications', description: 'Important updates only' },
                { key: 'whatsapp', label: 'WhatsApp notifications', description: 'Real-time updates' },
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              <a href="/dashboard/bookings" className="flex items-center gap-2 text-sm text-primary-600 hover:text-primary-700">
                <ExternalLink size={14} />
                View booking history
              </a>
              <a href="/dashboard/quotes/new" className="flex items-center gap-2 text-sm text-primary-600 hover:text-primary-700">
                <ExternalLink size={14} />
                Request a quote
              </a>
              <a href="/dashboard/support" className="flex items-center gap-2 text-sm text-primary-600 hover:text-primary-700">
                <ExternalLink size={14} />
                Get help
              </a>
            </CardContent>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <Select
              ...
              onChange={(e) => setVehicleForm(prev => ({ ...prev, bodyType: e.target.value }))}
            />
          </div>
          <Input
      ...
      >
        ...
        <ModalActions>
          <Button variant="secondary" onClick={() => setAddressModal({ open: false, address: null })}>
            Cancel
          </Button>
