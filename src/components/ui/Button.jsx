...
const variants = {
  ...
  outline: 'bg-transparent text-primary-600 border border-primary-300 hover:bg-primary-50 dark:text-primary-400 dark:border-primary-600 dark:hover:bg-primary-900/20',
